    ...
    <div class="col-sm-12">
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <div class="hr-line-dashed"></div>
                <?= $form->field($model, 'alias')->textInput(['maxlength' => 64,'placeholder' => '请不要输入已存在的别名']) ?>
                <div class="hr-line-dashed"></div>
                <?= $form->field($model, 'sort')->textInput(['maxlength' => 512]) ?>
                <div class="hr-line-dashed"></div>
                <?= $form->field($model, 'remark')->textarea(['rows' => 10,'placeholder' => '分类简介，只能输入255个字符']) ?>
                <?= $form->field($model, 'cover')->imgInput(['width' => '200px']) ?>
                <?= $form->defaultButtons() ?>
                <?php ActiveForm::end(); ?>
            </div>
        </div>
