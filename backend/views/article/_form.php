            ...
            <div class="ibox-content">
                <div class="row form-body form-horizontal m-t">
                    ...
                    <div class="col-md-7 droppable sortable ui-droppable ui-sortable" style="">
                        ...
                        <?= $form->field($model, 'summary')->textArea(['placeholder' => '概要，只能输入255个字符']); ?>
                        ...
                        <?= $form->field($model, 'set_meal')->textarea(['rows' => 10,'placeholder' => '输入文章ID拼接成一行，一行一个套餐，例子(1,2,3)']); ?>
                    </div>
                    <!--left stop -->
                                    ...
                                    <div class="col-sm-12 col-sm-offset-1">
                                        <div class="form-group col-sm-12 field-article-parent_id">
                                            <div class="col-sm-12 m-l-n">
                                                <?= $form->field($model, 'cid')->label('')->dropDownList(Category::getCategoriesName(), ['multiple'=>'','style'=>'height:500px;'])?>
                                            </div>
                    ...
                    <div class="col-md-5 droppable sortable ui-droppable ui-sortable" style="">
                        ...
                        <div class="ibox-content">
                            ...
                            <?= $form->field($model, 'seo_keywords', [
                                'size' => 9,
                                'labelOptions' => ['class' => 'col-sm-3']
                            ])->textInput(['placeholder' => 'seo关键字用英文字符逗号(,)分隔,例子(你好,他好,我好)']); ?>
                    ...
                    <div class="col-md-5 droppable sortable ui-droppable ui-sortable" style="">
                        ...
                        <div class="ibox-content">
                            ...
                            <?= $form->field($model, 'tag')->textInput(['placeholder' => '标签用英文字符逗号(,)分隔,例子(你好,他好,我好)']); ?>
                            <?= $form->field($model, 'sort')->textInput(); ?>
                            <?= $form->field($model, 'price')->textInput(); ?>
                            <?= $form->field($model, 'sale_price')->textInput(); ?>
                            <?= $form->field($model, 'study_number')->textInput(); ?>
