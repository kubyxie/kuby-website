                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'format' => 'raw',
                            'value' => function ($model) {
                                $cidType = Category::getCategoryType($model->cid,$model->type);
                                $url = $model->title;
                                if ($model->status == \common\models\Article::ARTICLE_PUBLISHED) {
                                    $url = "<a target='_blank' href='" . yii::$app->params['site']['url'] . $cidType.'/' . $model->id . "'>" .$model->title. '</a>';
                                }
                                return $url;
                            },
                        ],
